...
var getURLs = function(){
	var testwindow = window.location.href;
		if (testwindow.includes("test")){
			var url = "https://mycouncil-test.northampton.digital/housingPayment"}
			else {url = "https://mycouncil.northampton.digital/housingPayment"}
	//var url = 'https://selfserve.northampton.gov.uk/mycouncil/housingPayment',
	params  = {},
	...
	if (data.success)
	{
		...
		strPaylinkURL+='&' + 'PaymentSourceCode='                      + '02';
